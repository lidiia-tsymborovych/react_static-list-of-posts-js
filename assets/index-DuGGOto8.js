...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const{name:t,email:i,body:n}=e;return j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:t})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i})]}),j.jsx("div",{className:"CommentInfo__body",children:n})]})},Lc=({comments:e=[]})=>e.length?j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Pc,{comment:t},t.id))}):j.jsxs(j.Fragment,{children:[j.jsx("hr",{}),j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}),Tc=({user:e})=>{const{name:t,email:i}=e;return j.jsx("a",{className:"UserInfo",href:`mailto:${i}`,children:t})},Mc=({post:e})=>{const{title:t,body:i,user:n,comments:a}=e;return j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:t}),j.jsxs("p",{children:[" Posted by  ",j.jsx(Tc,{user:n})]})]}),j.jsx("p",{className:"PostInfo__body",children:i}),j.jsx(Lc,{comments:a})]})},Rc=({posts:e})=>e.map(t=>j.jsx(Mc,{post:t},t.id)),Dc=e=>Nc.find(t=>t.id===e),jc=e=>zc.filter(t=>t.postId===e),Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(j.jsx(Fc,{}));
